...
Description:   K-Means Clustering Algorithm on a real data set. Dataset found
               at https://archive.ics.uci.edu/ml/datasets/seeds#
...
def getData(dataFile):
    ...
    with open(dataFile,'r') as f:
        ...
        for line in lines:
            for item in line:
                # Random spaces found between data points............
                if item == ' ' or item == '':
                    del line[line.index(item)]
